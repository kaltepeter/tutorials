  ...
  <div class="flex bg-gray-100">
    ...
    >
      <div class="xl:max-w-lg xl:ml-auto">
        ...
        <img
          class="mt-6 sm:mt-8 sm:h-72 sm:w-full sm:object-cover sm:object-center rounded-lg shadow-xl lg:hidden"
        ...
        >
          You can work from anywhere.<br class="hidden lg:hidden" />
        ...
        <div class="mt-4 sm:mt-6">
          <a
            class="btn bg-brand-blue text-white sm:text-base shadow-lg"
            href="#"
            >Book your escape</a
          >
          <a class="ml-2 btn btn-gray sm:text-base" href="#">Lean more</a>
        </div>
      </div>
    </div>
